        ...
        <div className="flex flex-col xl:px-20 py-5 px-5 lg:flex-row gap-4  w-full xl:justify-center items-center ">
            {
                resultData.map((result, index: number) => (
                    <div className="text-center p-5 rounded-xl backdrop-blur-md bg-white/20 border-2 border-primary/30 shadow-lg shadow-fuchsia-300 md:flex-row flex-col w-full">
